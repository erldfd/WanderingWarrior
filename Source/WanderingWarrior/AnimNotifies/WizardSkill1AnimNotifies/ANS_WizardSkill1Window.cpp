...
void UANS_WizardSkill1Window::BranchingPointNotifyTick(FBranchingPointNotifyPayload& BranchingPointPayload, float FrameDeltaTime)
{
	...
	{
		UE_LOG(LogTemp, Warning, TEXT("UANS_WizardSkill1Window::BranchingPointNotifyTick, Character == nullptr"));
		return;
	}
	...
	{
		UE_LOG(LogTemp, Warning, TEXT("UANS_WizardSkill1Window::BranchingPointNotifyTick, SkillComp == nullptr"));
		return;
	}
	...
	{
		UE_LOG(LogTemp, Warning, TEXT("UANS_WizardSkill1Window::BranchingPointNotifyTick, AnimInstance == nullptr"));
		return;
	}
	...
	if (AnimInstance->GetBeingStunned())
	{
		...
		UE_LOG(LogTemp, Warning, TEXT("UANS_WizardSkill1Window::BranchingPointNotifyTick, AnimInstance->GetBeingStunned()"));
