...
void UInventoryManager::InitManager(const UWorld& World)
{
	TempSwapSlot = NewObject<UInventorySlotObject>();

	//BindFunctionToDragDropDelegate(EInventory::CharacterInventory, ETabType::WeaponTab);
	//BindFunctionToDragDropDelegate(EInventory::CharacterInventory, ETabType::MiscTab);
	//BindFunctionToDragDropDelegate(EInventory::CharacterQuickSlot, ETabType::QuickSlotTab);
}
